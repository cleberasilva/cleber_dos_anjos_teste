  ...
  <div id="header">
    ...
    <div id="menubar">
      <ul id="menu">
        ...
        <li class="selected"><a href="Motoristas.php">Motoristas</a></li>
    ...
    <div id="site_content">
      <div id="content">
      <form method="POST" class="form-horizontal" action="../scripts/persist_motorista.php">
        <fieldset>
            ...
            <div class="form-group">
                <label for="modelo" class="control-label col-sm-3">Modelo do Carro</label>
                <div class="col-sm-4">
